	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (op.trim().equals("addcategory")) {
				...
				int catid = categroyDao.saveCat(cat);

				System.out.println("cate saved");

				massage massage1 = new massage("New Category added", "Login error", "Smsgs text-center");
			...
			/*	get cate*/
				...
				massage massage1 = new massage("New Product added", "Login error", "alert-success text-center");
